        ...
        <div className="z-20 w-full bg-darkBg/60">
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center max-w-md">
                    ...
                    Con más de 2 de experiencia en el campo de la tecnología y la informática, he desarrollado una sólida base de conocimientos en inteligencia artificial (IA) y ciberseguridad. Actualmente, me desempeño como Desarrollador de IA, donde aplico mi experiencia en IA para crear soluciones innovadoras y escalables.                    </p>
